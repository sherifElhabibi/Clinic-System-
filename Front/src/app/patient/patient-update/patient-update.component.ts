...
export class PatientUpdateComponent {
  constructor(private fb: FormBuilder, public patientServ: PatientService,public activeRoute:ActivatedRoute) {}
  ...
  updateUser(){
    // this.patientServ.updatePatient(this.registrationForm.value).subscribe(response => {
    //   console.log("success");
    ...
    this.activeRoute.params.subscribe(a=>{
      console.log(a);
      this.patientServ.updatePatient(this.registrationForm.value,a['id']).subscribe(response=>console.log("success"), error=>console.log(error))
    })
  }
}
